...
impl TesTemperature {
    pub const fn new(temperature_c: i8, decimal: u8) -> Self {
        Self {
...
impl TesPressure {
    pub const fn new(pressure_hpa: i32, decimal: u8) -> Self {
        Self {
...
impl Default for TesConfiguration {
    fn default() -> Self {
        Self {
            temperature_interval_ms: 10_000,
            pressure_interval_ms: 10_000,
            humidity_interval_ms: 10_000,
            color_interval_ms: 10_000,
            gas_interval_mode: 2,
